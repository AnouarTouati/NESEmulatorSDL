...
namespace UnitTests
{
	...
	TEST_METHOD(ADC_IME) {
		...
		//TEST1
		aCPU = CreateIME_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateIME_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_ZABS) {
		uint8_t OPCode = 0x65;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;

		//TEST1
		aCPU = CreateZABS_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateZABS_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_ZINX) {
		uint8_t OPCode = 0x75;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;

		//TEST1
		aCPU = CreateZINX_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateZINX_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_ABS) {
		...
		//TEST1
		aCPU = CreateABS_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateABS_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_INX_X) {
		uint8_t OPCode = 0x7D;
		uint8_t InstructionLength = 0x03;
		CPU* aCPU;

		//TEST1
		aCPU = CreateINX_X_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateINX_X_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_INX_Y) {
		uint8_t OPCode = 0x79;
		uint8_t InstructionLength = 0x03;
		CPU* aCPU;

		//TEST1
		aCPU = CreateINX_Y_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreateINX_Y_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_PRII) {
		uint8_t OPCode = 0x61;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;

		//TEST1
		aCPU = CreatePRII_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreatePRII_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
	...
	TEST_METHOD(ADC_POII) {
		uint8_t OPCode = 0x71;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;

		//TEST1
		aCPU = CreatePOII_Instruction(OPCode, 0b01111000);
		aCPU->A = 0b01101001;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
		...
		//TEST4
		aCPU = CreatePOII_Instruction(OPCode, 0b11111000);
		aCPU->A = 0b10000111;
		aCPU->ResetCarry();
		aCPU->ExecuteNextInstruction();
		Assert::IsTrue(aCPU->GetOverflow());
...
public:
	...
	TEST_METHOD(ROR_ACC) {
		...
		Assert::IsFalse(aCPU->GetZero());
		Assert::IsTrue(aCPU->GetSign());
		Assert::AreEqual(0b10101000, (int)aCPU->A);

		Assert::AreEqual(0x0000 + InstructionLength, (int)aCPU->PC);
		Assert::IsTrue(aCPU->FinishedExecutingCurrentInsctruction);
	}
	TEST_METHOD(ROR_ZABS) {
		uint8_t OPCode = 0x66;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;
		...
		//TEST2
		aCPU = CreateZABS_Instruction(OPCode, 0b01010000);
		aCPU->SetCarry();
		aCPU->ExecuteNextInstruction();
		...
		Assert::IsFalse(aCPU->GetZero());
		Assert::IsTrue(aCPU->GetSign());
		Assert::AreEqual(0b10101000, (int)*aCPU->CPUMemory[TargetDataAddress_ZABS_MODE]);

		Assert::AreEqual(0x0000 + InstructionLength, (int)aCPU->PC);
		Assert::IsTrue(aCPU->FinishedExecutingCurrentInsctruction);
	}
	TEST_METHOD(ROR_ZINX) {
		uint8_t OPCode = 0x76;
		uint8_t InstructionLength = 0x02;
		CPU* aCPU;
		...
		//TEST2
		aCPU = CreateZINX_Instruction(OPCode, 0b01010000);
		aCPU->SetCarry();
		aCPU->ExecuteNextInstruction();
		...
		Assert::IsFalse(aCPU->GetZero());
		Assert::IsTrue(aCPU->GetSign());
		Assert::AreEqual(0b10101000, (int)*aCPU->CPUMemory[TargetDataAddress_ZINX_MODE]);
	...
	TEST_METHOD(ROR_ABS) {
		...
		//TEST2
		aCPU = CreateABS_Instruction(OPCode, 0b01010000);
		aCPU->SetCarry();
		aCPU->ExecuteNextInstruction();
		...
		Assert::IsFalse(aCPU->GetZero());
		Assert::IsTrue(aCPU->GetSign());
		Assert::AreEqual(0b10101000, (int)*aCPU->CPUMemory[TargetDataAddress_ABS_MODE]);

		Assert::AreEqual(0x0000 + InstructionLength, (int)aCPU->PC);
		Assert::IsTrue(aCPU->FinishedExecutingCurrentInsctruction);
	}
	TEST_METHOD(ROR_INX_X) {
		uint8_t OPCode = 0x7E;
		uint8_t InstructionLength = 0x03;
		CPU* aCPU;
		...
		//TEST2
		aCPU = CreateINX_X_Instruction(OPCode, 0b01010000);
		aCPU->SetCarry();
		aCPU->ExecuteNextInstruction();
		...
		Assert::IsFalse(aCPU->GetZero());
		Assert::IsTrue(aCPU->GetSign());
		Assert::AreEqual(0b10101000, (int)*aCPU->CPUMemory[TargetDataAddress_INX_X_MODE]);

		Assert::AreEqual(0x0000 + InstructionLength, (int)aCPU->PC);
		Assert::IsTrue(aCPU->FinishedExecutingCurrentInsctruction);
	}
};
TEST_CLASS(LSR_INSTRUCTIONS) {


	TEST_METHOD(LSR_ACC) {
		//opcoe 0x4A 1 byte long
		CPU* aCPU;
		//TEST1
		aCPU = CreateACC_Instruction(0x4A);
		...
		Assert::IsFalse(aCPU->GetSignFromData(&aCPU->A));
		Assert::IsFalse(aCPU->GetZero());
		Assert::AreEqual(0b00100000, (int)aCPU->A);
	...
	TEST_METHOD(LSR_ZABS) {
		//opcode 0x46 2 bytes long
		CPU* aCPU;
		//TEST1
		aCPU = CreateZABS_Instruction(0x46, 0b00000001);
		...
		//TEST2
		aCPU = CreateZABS_Instruction(0x46, 0b01000000);
		...
		Assert::IsFalse(aCPU->GetSignFromData(aCPU->CPUMemory[TargetDataAddress_ZABS_MODE]));
		Assert::IsFalse(aCPU->GetZero());
		Assert::AreEqual(0b00100000, (int)*aCPU->CPUMemory[TargetDataAddress_ZABS_MODE]);

		Assert::AreEqual(0x02, (int)aCPU->PC);
		Assert::IsTrue(aCPU->FinishedExecutingCurrentInsctruction);

	}
	TEST_METHOD(LSR_ZINX) {
		//opcode 0x56 2 bytes long
		CPU* aCPU;
		//TEST1
		aCPU = CreateZINX_Instruction(0x56, 0b00000001);
		...
		//TEST2
		aCPU = CreateZINX_Instruction(0x56, 0b01000000);
		...
		Assert::IsFalse(aCPU->GetSignFromData(aCPU->CPUMemory[TargetDataAddress_ZINX_MODE]));
		Assert::IsFalse(aCPU->GetZero());
		Assert::AreEqual(0b00100000, (int)*aCPU->CPUMemory[TargetDataAddress_ZINX_MODE]);
	...
	TEST_METHOD(LSR_ABS) {
		...
		CPU* aCPU;
		//TEST1
		aCPU = CreateABS_Instruction(0x4E, 0b00000001);
		...
		//TEST2
		aCPU = CreateABS_Instruction(0x4E, 0b01000000);
		...
		Assert::IsFalse(aCPU->GetSignFromData(aCPU->CPUMemory[TargetDataAddress_ABS_MODE]));
		Assert::IsFalse(aCPU->GetZero());
		Assert::AreEqual(0b00100000, (int)*aCPU->CPUMemory[TargetDataAddress_ABS_MODE]);
	...
	TEST_METHOD(LSR_INX_X) {
		//opcode 0x5E 3 bytes long
		CPU* aCPU;
		//TEST1
		aCPU = CreateINX_X_Instruction(0x5E, 0b00000001);
		...
		//TEST2
		aCPU = CreateINX_X_Instruction(0x5E, 0b01000000);
		...
		Assert::IsFalse(aCPU->GetSignFromData(aCPU->CPUMemory[TargetDataAddress_INX_X_MODE]));
		Assert::IsFalse(aCPU->GetZero());
		Assert::AreEqual(0b00100000, (int)*aCPU->CPUMemory[TargetDataAddress_INX_X_MODE]);
